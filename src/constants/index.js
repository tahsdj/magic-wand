...
export const MONSTERS = [
    {
        ...
        description: '你來到一座隱蔽的山林，這裡據說有著珍貴的材料。\n你在數百公里外就看到了牠 -- 如一座山一般大的生物，牠似乎在沉睡著，四周的山林隨著他的哈欠吹出的落山風而變形，禮讓出了一個只屬於牠的溫柔睡床。隨後你注意到了牠身上漂浮著的大塊結晶，那就是散發著魔力的純化材料。\n你一心想著要得到他們，於是你往前邁進，但隨著你越來越靠近，牠發出的轟鳴使你腳邊的土地隨之震動，震動幅度越來越大。\n你開始猶豫：是否不該擾人清夢?',
        materials: [
            {
                name: '寶石粉',
                value: 0,
    ...
    },
    {
        ...
        description: '穿梭在重重的森林中，忽見一面清澈的湖。湖面中浮出一位美麗的女子，看起來就是傳說中的湖抖女神。她會考驗每個的挑戰者的誠信，任何的謊話都逃不過他的魔掌，用誘惑的言語在你心中掀起每個人心中貪婪的漣漪。',
        categroy: "湖抖女神",
        type: 'monster',
        materials: [
            {
    ...
    },
    {
        ...
        description: '這裡有著只有在滿月的夜晚才能遇見的生物，嚴格來說，是寄生生物。\n你會先聽見牠為了寄生更多同類而發出的嚎叫，接著，牠便會在皎潔的月光下現身。\n牠會利用牠的宿主全身上下能夠發出體味的腺體，讓被吸引而來的同類發狂似的撕咬牠，使得牠能夠寄生在更多的......噓！就在那裏。\n你只有一瞬間的機會，你必須要俐落的，\n趁著狼群張牙舞爪前，\n先下手為強。',
        categroy: "寄生生物",
        materials: [
            {
                name: '狼毫',
    ...
    },
    {
        ...
        description: "你在某個夜晚來到了某個城鎮，長途跋涉耗光了全身的精力，只想好好吃個東西填飽肚子，然而發現身上卻沒剩半毛錢。\n你剛看到巷子旁剛好有個ATM，興高采烈地走去。\n正當插入提款卡時，卻從後方感受被一股令人不安的視線給盯著，但回頭卻又不見蹤影。\n難到在這個小小的空間中還有其他人的存在？為了領出錢是否該面對這令人討厭的威脅。",
        type: 'monster',
        materials: [
            {
                name: '50元銅板',
    ...
    },
    {
        ...
        description: "在隔壁鎮閒逛時，你巧遇了穿著閃亮西裝外套的壁虎先生。\n牠身上的閃光貼紙隨著晃悠著的大尾巴一閃一閃，手中抱著的紙袋是牠誓死捍衛的午餐。",
        materials: [
            {
                name: '斷尾',
                value: 3,
    ...
    },
    {
        ...
        description: "你遇見了和一間房子一樣大的貝類，巨大的貝殼裡放著數以千萬金碧輝煌的寶藏。\n等等，你觀察了一陣子之後發現有些不對勁：\n那些金碧輝煌的寶藏似乎是誘惑你的陷阱，你正猶豫不決該怎麼做...",
        type: 'monster',
        materials: [
            {
                name: '深海泡沫',
